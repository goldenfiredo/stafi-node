...
//! The Stafi runtime. This can be compiled with `#[no_std]`, ready for Wasm.
...
type SessionHandlers = (Grandpa, Babe, ImOnline, AuthorityDiscovery, AtomStaking, XtzStaking);
...
construct_runtime!(
	pub enum Runtime where
		Block = Block,
		NodeBlock = stafi_primitives::Block,
